...
The application displays a training programme in a calendar view, showing planned training sessions for each day or indicating rest days. Users can check off completed sessions and view weekly training volumes (both planned and actual).
